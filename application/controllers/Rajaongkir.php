...
private $api_key ='4b92eece3207c82abaf7249a33b6e9b9';
...
public function provinsi()
    ...
    {
        $id_provinsi_pilihan =$this->input->post('id_provinsi');
        
        $curl = curl_init();

        curl_setopt_array($curl, array(
          CURLOPT_URL => "https://api.rajaongkir.com/starter/city?province=". $id_provinsi_pilihan,
          CURLOPT_SSL_VERIFYHOST=>0,
          CURLOPT_SSL_VERIFYPEER=>0,
          CURLOPT_RETURNTRANSFER => true,
          CURLOPT_ENCODING => "",
    ...
    public function expedisi(){
      echo'<option value="">Pilih Expedisi Pengiriman Anda</option>';
    ...
    echo "cURL Error #:" . $err;
     ...
     // echo $response;
      $array_response = json_decode($response, true);
        ...
        echo" <option value=''>Pilih Paket Pengiriman Anda</option>";
